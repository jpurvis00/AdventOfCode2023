...
//by a semicolon-separated list of subsets of cubes that were revealed from the bag (like 3 red, 5 green, 4 blue).
...
internal class Program
{
    ...
    {
        string path = @"C:\Users\jeffp\source\repos\AdventOfCode2023\CubeConundrum\GameInput.txt";
        string[] fileTextByLine = Data.ReadDataFromFile(path);

        Console.WriteLine($"The possible game tally is: {CheckGame.CheckIfGameIsPossible(fileTextByLine)}");
